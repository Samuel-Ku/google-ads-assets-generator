...
A Shape is editable geometry, distinct from an uploaded Element. Begin with two primitives to establish a complete compatible workflow; ticket 6 adds the remaining four. This workflow is independently usable in Display and Team Templates and does not require the PMax feature to land first.
...
Coordination: this ticket and ticket 3 share a generic full-composition rendering contract, not a blocking edge. Whichever lands second verifies shape preservation through composed/clean PMax switching and actual export; neither may regress the earlier feature.
