...
- [ ] Display retains these shapes; clean RDA/PMax and logo-only outputs exclude them. If composed PMax has landed, verify these shapes through mode switching and real export; otherwise keep the full-composition contract compatible so ticket 3 verifies them when it lands.
...
- Ticket 5 — Add reusable rectangle and square Shape layers.
